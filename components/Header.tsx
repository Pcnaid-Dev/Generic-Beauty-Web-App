...
import { UndoIcon, RedoIcon, EyeIcon, HistoryIcon, DownloadIcon, UploadIcon, ResetIcon, SparkleIcon, GridIcon, ZoomInIcon, ZoomOutIcon, FitToScreenIcon } from './icons';
...
const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="w-full py-3 px-4 md:px-6 border-b border-gray-700 bg-gray-800/50 backdrop-blur-md sticky top-0 z-50 flex items-center justify-between flex-shrink-0">
